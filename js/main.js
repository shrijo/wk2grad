function getSliderValue(slider){
  ...
  if (parseInt(slider.value) >= 0 && parseInt(slider.value, 10) < 95){
    ...
    CABLES.patch.setVariable("frameGlacierOne", Math.floor( 111 + 164 / 140 * (parseInt(slider.value, 10)- 95), 10));
  }
    ...
    CABLES.patch.setVariable("frameGlacierOne", Math.floor( 275 + 53 / 45 * (parseInt(slider.value, 10) - 234), 10));
  }
