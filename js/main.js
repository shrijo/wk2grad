function getSliderValue(slider){
  ...
  if (parseInt(slider.value) >= 0 && parseInt(slider.value, 10) < 111){
    ...
    CABLES.patch.setVariable("frameGlacierOne", parseInt(Math.floor( 1 + parseInt(slider.value, 10) / 111 ), 10));
  }
    ...
    CABLES.patch.setVariable("frameGlacierOne", parseInt(Math.floor( 111 + parseInt(slider.value, 10) / 164 ), 10));
  }
    ...
    CABLES.patch.setVariable("frameGlacierOne", parseInt(Math.floor( 275 + parseInt(slider.value, 10) / 53 ), 10));
  }
